...
public class MarcaController {
  ...
  public @ResponseBody String deleteById(@RequestParam Integer idMarca) {
    // This returns a JSON or XML with this user
  ...
  public @ResponseBody String PutById(@PathVariable (value="id") Integer Fornecedor, @RequestParam Integer idMarca, String nome, String descricao) {
    // This returns a JSON or XML with this user
