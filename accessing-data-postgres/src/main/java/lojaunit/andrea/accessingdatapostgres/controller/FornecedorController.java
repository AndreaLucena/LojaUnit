...
public @ResponseBody String deleteById(@RequestParam Integer idFornecedor) {
  // This returns a JSON or XML with this user
	  
	  if (fornecedorRepository.findById(idFornecedor) == null) {
...
public @ResponseBody String PutById(@PathVariable (value="id") Integer Fornecedor,@RequestParam Integer idFornecedor, String nome, String email, Integer cnpj, Integer telefone, String endereco) {
  // This returns a JSON or XML with this user
